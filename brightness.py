...
def blend (image1,op1,image2,op2):
    ...
    imgBlend = np.clip(imgBlend,0,0,255)
    return imgBlend.astype(np.uint8)

img1 = img. imread("C:\\Users\\KOMPUTER 20\\Downloads\\vincent r.jpg")
img2 = img. imread("C:\\Users\\KOMPUTER 20\\Downloads\\vincent r2.jpg")
